...
colors = [(1, 1, 1), (1, 0, 1), (1, 1, 0), (0, 1, 1), (0, 1, 0)]

# Define the geometry of the system
geometries = [dict(position=(10, 7, 0), size=(10, 1.9, 1.9)),
              dict(origin=(0, 0, 0), size=(22.0, 1.0, 22.0)),
              dict(origin=(0, 0, 0), size=(2.0, 1.0, 22.0)),
              dict(origin=(0, 0, 0), size=(2, 2, 2)),
              dict(origin=(0, 8, 0), size=(2, 1, 2))]

# List of pairs to ignore
ignore = [[1, 2], [1, 3], [1, 4], [2, 3], [2, 4], [3, 4]]
